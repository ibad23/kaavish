...
\begin{itemize}
    ...
    \item \textbf{Prompt Engineering Methodology:} Though not originally proposed as a deliverable, the iterative prompt engineering process (9 + 7 iterations of instruction files) emerged as a significant contribution, it is, in effect, the algorithm at the core of the Design-to-Code pipeline.
